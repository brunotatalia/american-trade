...
export const playErrorSound = () => {
  try {
    ...
    oscillator.frequency.exponentialRampToValueAtTime(261.63, ctx.currentTime + 0.1); // C4
...
// Play a purchase sound (quick beep)
export const playPurchaseSound = () => {
  try {
    ...
    console.warn('Could not play purchase sound:', e);
  }
};

// Play a sell sound (quick descending beep)
export const playSellSound = () => {
  try {
    ...
    console.warn('Could not play sell sound:', e);
  }
};
