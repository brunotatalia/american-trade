...
export const ERAS_DATA: Era[] = [
  {
    ...
    startDate: { month: 1, year: 1950 },
    endDate: { month: 12, year: 1989 }
  },
  {
    id: 'DOTCOM_BUBBLE',
...
export const JOBS_DATA: Record<string, Job> = {
  ...
  CUSTOMER_SERVICE_REP: {
    ...
    basePayPerTurn: 180,
    requiredSkills: [],
    description: "Handle customer inquiries and resolve issues. Communication skills required.",
  ...
  FINANCIAL_ANALYST: {
    ...
    description: "Analyze market data and make recommendations. Financial knowledge required.",
    miniGameType: 'trivia_quiz',
    difficulty: 'hard',
  ...
  BUSINESS_CONSULTANT: {
    ...
    description: "Solve complex business problems. Negotiation skills critical.",
    miniGameType: 'negotiation',
    difficulty: 'hard',
  ...
  IT_SUPPORT: {
    ...
    basePayPerTurn: 280,
    requiredSkills: [],
    description: "Troubleshoot technical issues. Technical knowledge and problem solving.",
    miniGameType: 'trivia_quiz',
    difficulty: 'medium',
  ...
  SOFTWARE_DEVELOPER: {
    ...
    description: "Write code and debug programs. Technical vocabulary essential.",
  ...
  RETAIL_MANAGER: {
    ...
    description: "Manage store operations and staff. Negotiation skills essential.",
    miniGameType: 'negotiation',
    difficulty: 'medium',
    icon: React.createElement(SkillIcon, {className: "text-blue-500"})
  },
  ...
  INSURANCE_AGENT: {
    ...
    description: "Sell insurance policies and assess coverage needs. Sales skills required.",
    miniGameType: 'negotiation',
    difficulty: 'medium',
  ...
  BUSINESS_ANALYST: {
    ...
    description: "Analyze business processes and recommend improvements. Business knowledge required.",
    miniGameType: 'trivia_quiz',
    difficulty: 'medium',
    icon: React.createElement(SkillIcon, {className: "text-indigo-500"})
  },
  MARKETING_MANAGER: {
    ...
    description: "Plan and execute marketing campaigns. Creative thinking and vocabulary.",
    miniGameType: 'word_scramble',
    difficulty: 'hard',
  ...
  HR_MANAGER: {
    ...
    description: "Manage hiring and employee relations. Communication and people skills essential.",
    miniGameType: 'negotiation',
    difficulty: 'medium',
  ...
  SALES_EXECUTIVE: {
    ...
    description: "Close high-value deals. Master negotiation and persuasion required.",
    miniGameType: 'negotiation',
    difficulty: 'hard',
  ...
  ELECTRICIAN: {
    ...
    basePayPerTurn: 380,
    requiredSkills: [],
    description: "Wire buildings and troubleshoot electrical systems. Technical knowledge required.",
    miniGameType: 'trivia_quiz',
    difficulty: 'medium',
    icon: React.createElement(SkillIcon, {className: "text-yellow-500"})
  },
  ...
  AUTO_MECHANIC: {
    ...
    basePayPerTurn: 340,
    requiredSkills: [],
    description: "Diagnose and repair vehicles. Mechanical knowledge essential.",
    miniGameType: 'trivia_quiz',
    difficulty: 'medium',
  ...
  PAINTER: {
    ...
    basePayPerTurn: 300,
    requiredSkills: [],
    description: "Paint buildings and structures. Attention to detail required.",
    miniGameType: 'word_scramble',
    difficulty: 'easy',
    icon: React.createElement(SkillIcon, {className: "text-indigo-400"})
  },
  ...
  HOTEL_MANAGER: {
    ...
    description: "Oversee hotel operations and guest services. Customer service skills essential.",
    miniGameType: 'negotiation',
    difficulty: 'medium',
    icon: React.createElement(PropertyIcon, {className: "text-purple-500"})
  },
  EVENT_PLANNER: {
    ...
    description: "Coordinate events and manage logistics. Creative organization key.",
    miniGameType: 'word_scramble',
    difficulty: 'medium',
    icon: React.createElement(SkillIcon, {className: "text-pink-500"})
  },
  ...
  NETWORK_ADMINISTRATOR: {
    ...
    description: "Maintain and secure computer networks. Technical knowledge essential.",
    miniGameType: 'trivia_quiz',
    difficulty: 'hard',
    icon: React.createElement(SkillIcon, {className: "text-indigo-600"})
  },
  CYBERSECURITY_ANALYST: {
    ...
    description: "Protect systems from cyber threats. Advanced security knowledge required.",
    miniGameType: 'trivia_quiz',
    difficulty: 'hard',
  ...
  UX_DESIGNER: {
    ...
    description: "Design user interfaces and experiences. Creative vocabulary and design thinking.",
    miniGameType: 'word_scramble',
    difficulty: 'medium',
